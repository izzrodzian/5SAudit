...
mysqli_select_db($con,'testing') or die ('No database found.');
...
<table class="table" style="width: 100%;" align="center">    
      ...
      <td><input type="file" name="myimage">
      </tr>
</table>
Catatan:<br>
...
<table class="table" style="width: 100%;" align="center">    
      ...
      <td><input type="file" name="imagescategory3">
      </tr>
    </table>
    Catatan:<br>
    <textarea name="catatans1category1" cols="100" rows="3"></textarea>
...
<br>
<br>
<div class="mbr-section-btn text-center"><a class="btn btn-primary display-4" href="Test2.php">SEKSYEN 2</a></div>
