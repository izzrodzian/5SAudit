...
<head>
  ...
  <title>Prasarana | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="dist/img/PrasaranaLogo.png" alt="Prasarana Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Prasarana</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- START ALERTS AND CALLOUTS -->
        <h5 class="mt-4 mb-2">Text Here</h5>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-default">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <font color="red"> Text and Image Here </font>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
